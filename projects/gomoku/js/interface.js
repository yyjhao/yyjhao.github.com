$(document).ready(function(){
	...
	$('.back-to-game').bind('tap',function(){
		$.mobile.changePage('#game-page',{transition: 'slidedown', reverse: true});
	});
	...
	$('.fullscreen-wrapper').on('tap', function(){
		$(this).hide();
		$.mobile.changePage('#game-won', {transition: 'pop'});
	});
	...
	$.mobile.changePage('#new-game',{changeHash: false, transition: 'slidedown'});
});
